const navbar = () => {
    ...
    <div class="dropdown-menu absolute -top-full left-0 max-lg:bg-[#fff] w-full flex flex-col gap-6 items-center py-3 text-lg font-bold lg:static lg:flex-row lg:justify-between">
        <div></div>
